  ...
  return (
    <div className="bg-background text-foreground font-sans min-h-screen selection:bg-primary/30 selection:text-primary pt-16">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-5 left-1/2 -translate-x-1/2 z-50 flex items-center gap-2 px-6 py-3 rounded-full font-bold text-white text-base shadow-[0_4px_24px_rgba(0,0,0,0.4)] transition-all duration-300 hover:scale-105 active:scale-95 md:hidden"
